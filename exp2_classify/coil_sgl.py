...
import numpy as np
from read_data import read_coil
...
X, y = read_coil(path)  # X(1440,1024), y(1440,),总共20个物品，每个物品是72张图片
category = 20
...
for k, y in enumerate(y_train):
    model = SGL(groups=Groups, l1_ratio=0.5, alpha=0.005).fit(X_train, y)
