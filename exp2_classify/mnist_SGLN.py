...
#加载数据
path = r'C:\Users\20934\Desktop\研究生毕设\双双姐承接\SparseGroupLassoNet\data\Mnist\mnist-original.mat'
X, y = read_mnist(path)
category = len(set(y))
data = []
for i in range(10):
...
# fig = ax.get_figure()
# fig.savefig("exp2_classify/figures/heatmap_SGLN.pdf", bbox_inches='tight')